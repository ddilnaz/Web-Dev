...
export let categories: Category[] = [new Category(1, "Legos", legos, false), new Category(2, "Phones", phones, false), 
                                new Category(3, "Appliances", appliances, false), new Category(4, "Jewelry", jewelry, false)];